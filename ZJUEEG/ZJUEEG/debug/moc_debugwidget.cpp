...
QT_MOC_LITERAL(1, 12, 25), // "signal_debug_widget_close"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 17), // "slot_show_message"
QT_MOC_LITERAL(4, 57, 17) // "slot_clear_widget"

    },
    "DebugWidget\0signal_debug_widget_close\0"
    "\0slot_show_message\0slot_clear_widget"
};
...
void DebugWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_debug_widget_close(); break;
        case 1: _t->slot_show_message(); break;
        case 2: _t->slot_clear_widget(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DebugWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DebugWidget::signal_debug_widget_close)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DebugWidget::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_DebugWidget.data,
    qt_meta_data_DebugWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void DebugWidget::signal_debug_widget_close()
{
